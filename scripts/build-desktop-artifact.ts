...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const publishConfig = AUTO_UPDATES_ENABLED
  ...
  if (platform === "mac") {
    ...
    buildConfig.mac = {
      ...
      protocols: [
        {
          name: APP_BASE_NAME,
          schemes: [protocolScheme(false), protocolScheme(true)],
        },
      ],
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      ...
      // t7code:// OAuth callbacks to the app.
      protocols: [
        {
          name: APP_BASE_NAME,
          schemes: [protocolScheme(false), protocolScheme(true)],
  ...
  if (platform === "win") {
    ...
    buildConfig.nsis = {
      ...
      shortcutName: APP_BASE_NAME,
      uninstallDisplayName: APP_BASE_NAME,
    };
