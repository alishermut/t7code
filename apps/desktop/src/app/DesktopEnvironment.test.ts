...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.t7code.app.dev");
      assert.equal(environment.linuxWmClass, "t7code-dev");
      assert.deepEqual(
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.t7code/dev");
      assert.equal(production.stateDir, "/Users/alice/.t7code/userdata");
    }),
  );
