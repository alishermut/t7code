...
import { LINUX_URL_HANDLER_DESKTOP_ENTRY_NAME } from "@t3tools/shared/appIdentity";
...
export const URL_HANDLER_DESKTOP_ENTRY_NAME = LINUX_URL_HANDLER_DESKTOP_ENTRY_NAME;
